...
const defs: Record<string, CommandEntry> = {
  ...
  reminder: {
    ...
    subcommandTriggers: {
      ...
      edit: ['editar'],
      interval: ['intervalo', 'cada'],
      weekly: ['semanal', 'semana'],
      monthly: ['mensal', 'mês', 'mes'],
      weekdays: ['dias-uteis', 'dias úteis', 'dias uteis', 'semana'],
      weekends: ['fim-de-semana', 'fim de semana'],
    },
    name: 'Lembrete',
    ...
    helpLines: [
      ...
      'lembrar intervalo 30 beber água — a cada 30 minutos',
      'lembrar semanal segunda 08:00 ir à academia — toda segunda às 08:00',
      'lembrar mensal 1 09:00 pagar aluguel — todo dia 1 às 09:00',
      'lembrar dias-uteis ir à academia 8am — seg–sex às 08:00',
      'lembrar dias-uteis 20:00 correr — seg–sex às 20:00',
      'lembrar fim-de-semana 10:00 ler — sáb–dom às 10:00',
...
export const pt: Locale = {
  ...
  responses: {
    ...
    recurringAdded: (text: string, desc: string) =>
      `🔄 Lembrete recorrente criado! *${text}* — ${desc}`,
    recurringNextLabel: 'próximo',
    recurringIntervalLabel: (mins: number) => `a cada ${mins} min`,
    recurringWeeklyLabel: (dayName: string, time: string) => `toda ${dayName} às ${time}`,
    recurringMonthlyLabel: (dom: number, time: string) => `todo dia ${dom} às ${time}`,
    recurringWeekdaysLabel: (time: string) => `segunda a sexta às ${time}`,
    recurringWeekendsLabel: (time: string) => `sábados e domingos às ${time}`,
  },
};
