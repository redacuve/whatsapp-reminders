...
const defs: Record<string, CommandEntry> = {
  ...
  reminder: {
    ...
    subcommandTriggers: {
      ...
      monthly: ['mensual', 'mes'],
      weekdays: ['entresemanales', 'laborables', 'dias-habiles', 'dias habiles'],
      weekends: ['fines-de-semana', 'fines de semana', 'fin de semana'],
    },
    name: 'Recordatorio',
    ...
    helpLines: [
      ...
      'recordar intervalo 30 tomar agua — cada 30 minutos',
      'recordar semanal lunes 08:00 ir al gym — cada lunes a las 08:00',
      'recordar mensual 1 09:00 pagar renta — cada día 1 a las 09:00',
      'recordar laborables ir al gym 8am — lun–vie a las 08:00',
      'recordar laborables 20:00 salir a correr — lun–vie a las 20:00',
      'recordar fines-de-semana 10:00 leer — sáb–dom a las 10:00',
...
export const es: Locale = {
  ...
  responses: {
    ...
    recurringAdded: (text: string, desc: string) =>
      `🔄 ¡Recordatorio recurrente creado! *${text}* — ${desc}`,
    recurringNextLabel: 'próximo',
    recurringIntervalLabel: (mins: number) => `cada ${mins} min`,
    recurringWeeklyLabel: (dayName: string, time: string) => `cada ${dayName} a las ${time}`,
    recurringMonthlyLabel: (dom: number, time: string) => `cada día ${dom} a las ${time}`,
    recurringWeekdaysLabel: (time: string) => `lunes a viernes a las ${time}`,
    recurringWeekendsLabel: (time: string) => `sábados y domingos a las ${time}`,
  },
};
