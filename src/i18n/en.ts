...
const defs: Record<string, CommandEntry> = {
  ...
  reminder: {
    ...
    helpLines: [
      ...
      'remind monthly 1 09:00 pay rent — every 1st of month at 09:00',
      'remind weekdays go to gym 8am — Mon–Fri at 08:00',
      'remind weekdays 8:00pm go for a run — Mon–Fri at 20:00',
      'remind weekends 10:00 read a book — Sat–Sun at 10:00',
...
export const en: Locale = {
  ...
  responses: {
    ...
    recurringIntervalLabel: (mins: number) => `every ${mins} min`,
    recurringWeeklyLabel: (dayName: string, time: string) => `every ${dayName} at ${time}`,
    recurringMonthlyLabel: (dom: number, time: string) => `every ${dom} of month at ${time}`,
    recurringWeekdaysLabel: (time: string) => `weekdays (Mon–Fri) at ${time}`,
    recurringWeekendsLabel: (time: string) => `weekends (Sat–Sun) at ${time}`,
  },
};
